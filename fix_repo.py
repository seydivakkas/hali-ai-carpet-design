...
lines = open('src/carpet_designer/persistence/repositories.py').read()
new_lines = lines.replace('''class EvaluationRepository:
    def __init__(self, conn):
        self.conn = conn
    ...
    def save(self, result):
        ...
        self.conn.commit()''', repo_replace.strip())

with open('src/carpet_designer/persistence/repositories.py', 'w') as f:
    f.write(new_lines)
